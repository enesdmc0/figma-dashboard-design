    ...
    return (
        <div className="col-span-4">
            ...
            <div className="flex bg-white">
                <div className=" rounded-md flex p-3 space-x-3 space-y-5">
                    <div className="bg-gray-200 flex-1 rounded-md">image</div>
                    <div className="flex-1">
                        ...
                        <div>Lorem Ipsum is simply dummy text of the typesetting industry. Lorem Ipsum has been
